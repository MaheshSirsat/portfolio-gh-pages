		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mahesh Sirsat - Portfolio",
									"targetURL": "#comportfolio-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comportfolio-display": {
								"semanticObject": "comportfolio",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.portfolio",
									"url": sap.ui.require.toUrl("com/portfolio")
								}
							}
						}
					}
